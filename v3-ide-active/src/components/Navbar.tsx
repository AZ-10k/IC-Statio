            ...
            {navLinks.map((link, index) => {
              ...
              return (
                <div
                  ...
                  className="group relative px-6 py-3 text-sm font-medium text-foreground transition-all duration-300 cursor-pointer rounded-xl hover:bg-gradient-to-r hover:from-wine/10 hover:to-blush/10 hover:shadow-lg hover:shadow-wine/10 hover:scale-105"
                ...
                {navLinks.map((link, index) => {
                  ...
                  return (
                    <div
                      key={link.name}
                      onClick={() => navigateWithLanguage(link.href)}
                      className="flex items-center gap-3 text-sm font-medium text-foreground hover:text-wine py-3 px-4 rounded-xl hover:bg-gradient-to-r hover:from-wine/10 hover:to-blush/5 cursor-pointer transition-all duration-300 hover:scale-105"
