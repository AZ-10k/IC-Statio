...
const Navbar = () => {
  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-50 bg-background/95 backdrop-blur-sm border-b border-border" dir={isRTL ? "rtl" : "ltr"}>
      <div className="container mx-auto px-4 lg:px-8">
        <div className="flex items-center justify-between h-16 lg:h-20">
          <a href="/" onClick={handleHomeClick} className="flex items-center gap-3 cursor-pointer">
            ...
            />
            <span className="hidden sm:block font-serif text-lg font-semibold text-primary">Instant Créatif Statio</span>
          </a>
